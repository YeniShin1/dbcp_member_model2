...
<body>
	...
	<table>
		<tr>
			...
			<td><input type="text" name="userid" id="userid" autofocus value="<%=userid %>" readonly>
			<small id="userid" class="text-into"></small>
			</td>
		</tr>
		<tr>
			<td>비밀번호</td>
			<td><input type="password" name="password" id="password">
			<small id="password" class="text-into"></small>
			</td>		
		</tr>
		<tr>
			<td>비밀번호 변경</td>
			<td><input type="password" name="confirm_password" id="confirm_password">
			<small id="confirm_password" class="text-into"></small>
			</td>		
		</tr>
		<tr>
			<td>이름</td>
			<td><input type="text" name="name" id="gender" value="<%=name %>" readonly>
